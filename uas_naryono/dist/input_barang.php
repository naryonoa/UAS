...
if(isset($_POST['Save'])){
	...
	$ketegori_id=$_POST['ketegori_id'];
	$satuan_id=$_POST['satuan_id'];
	$harga=$_POST['harga'];
$query=mysqli_query($koneksi,"insert into barang1(nama_barang,ketegori_id,satuan_id,harga)
value ('$nama_barang',
'$ketegori_id',
'$satuan_id','$harga')");
if($query){
...
<table border="1" class="table table-bordered">
	...
	<tr>
		...
		<td><select class="form-control" name="ketegori_id">
		...
		<td><select class="form-control" name="satuan_id">
			<option value="">-----Pilih-----</option>
			<?php 
			$sql_satuan = mysqli_query ($koneksi, "Select * from satuan1" ) or die
			(mysql_error($koneksi));
